...
/**
 * The persistent class for the flow_cash_in database table.
 * 
 */
@Entity
@Table(name="flow_cash_in")
@NamedQuery(name="FlowCashIn.findAll", query="SELECT f FROM FlowCashIn f")
public class FlowCashIn implements Serializable {
